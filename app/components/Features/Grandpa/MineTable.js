...
function MineTable({ ...props }) {
  ...
  return (
    <ToolBody color="success" icon={Restore} header="Mining" subheader=" - You can mine every 12 hours">
      {referrer ? (
        <h5>
              ...
              tokens.map(row => {
                ...
                return (
                  <TableRow className={classes.tableRowHover} key={row}>
                    ...
                    <TableCell className={classes.tableCell}>{thisMined || 'Never'}</TableCell>
